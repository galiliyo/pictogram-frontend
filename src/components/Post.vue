    ...
    <div class="post-info">
      <div class="controls flex space-between px-3 pt-2">
        <div class="user-actions">
          <i class="icon icon-love-it-circle btn-icon" @click="likePostToggle()"></i>
...
export default {
  ...
  async created() {
    this.postLikedByUser = this.loggedInUser.likedPosts.includes(this.post._id);
    try {
  ...
  methods: {
    goDetails() {},
    likePostToggle() {
      console.log("toggle", this.postLikedByUser);
